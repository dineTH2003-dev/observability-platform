      ...
      <div className="group relative flex items-center">
        ...
        <Select disabled={disabled} value={value} onValueChange={onChange}>
          <SelectTrigger
            ...
            className="h-12 rounded-xl border-white/8 bg-[#0A1238] pl-10 pr-10 text-left text-sm text-white shadow-inner shadow-black/20 transition duration-200 hover:border-white/12 focus-visible:ring-nebula-purple/30 disabled:opacity-70"
          >
